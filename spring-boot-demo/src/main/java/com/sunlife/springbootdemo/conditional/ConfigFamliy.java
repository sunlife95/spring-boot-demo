...
import com.sunlife.springbootdemo.bean.Role;
import com.sunlife.springbootdemo.bean.User;
import com.sunlife.springbootdemo.bean.ZgGoods;
...
public class ConfigFamliy {
    ...
    * */
    @Bean
    @ConditionalOnClass(name = "com.sunlife.springbootdemo.controller.JackController1")
    public Role getRole() {
    ...
    * */
    @Bean
    @ConditionalOnMissingClass(value = "com.sunlife.springbootdemo.controller.JackController1")
